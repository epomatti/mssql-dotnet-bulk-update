...
class DataLoader
{
  ...
  private void CreateMessages()
  {
    ...
    for (int i = 0; i < msgsQty; i++)
    {
      ...
      dataTable.Rows.Add(values);
      // dataTable.Rows.Add({1, DateTime.Now}); // Priority
      // dataTable.Rows.Add(DateTime.Now); // Created At
    ...
    adapter.InsertCommand = new SqlCommand("INSERT INTO Message (Priority, CreatedAt) VALUES (@Priority, @CreatedAt);", connection);
